...
| 1.2b | Hex grid overlay | 12 | **done both platforms** — real H3 cells with boundary geometry, drawn as filled polygons at resolution 9 (zoomed in) or 8 (out), with an overlay toggle. Hexagon observed at Georgia Tech on iOS 17.5 sim and `Medium_Phone_API_36`, identical on both. |
