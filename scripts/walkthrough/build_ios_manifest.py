...
STEPS = [
    ("01-map-home", "Launch — map home",
     "The app opens on the map. Saved measurements are drawn as pins, and the panel reports "
     "what sync has done rather than a bare queue count.",
     ["Measure button present"]),
    ("02-start-measurement", "Tap Measure — pre-flight",
    ...
    ("03-in-vehicle", "Toggle in-vehicle",
    ...
    ("04-wifi-confirmation", "Wi-Fi confirmation",
    ...
    ("05-run-in-progress", "Run in progress",
    ...
    ("07-map-home-after", "Back to the map",
