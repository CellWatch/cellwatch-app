package com.cellwatch.ui.measurement.viewmodels
...
class MeasurementViewModel(private val repository: com.cellwatch.data.core.repositories.MeasurementRepository) : ViewModel() {
...
class MeasurementViewModelFactory(private val repository: com.cellwatch.data.core.repositories.MeasurementRepository) : ViewModelProvider.Factory {
