...
fun MeasurementWithData.asExternalModel() = Measurement(
    ...
    simMobileCountryCode = measurement.simMobileCountryCode,
    simMobileNetworkCode = measurement.simMobileNetworkCode,
    netMobileCountryCode = measurement.netMobileCountryCode,
    netMobileNetworkCode= measurement.netMobileNetworkCode,
